...
const Dashboard = props => (
  <svg viewBox="0 0 64 48" {...props}>
    ...
    />
    <circle className="st0" cx={16} cy={16} r={2} />
    <circle className="st0" cx={32} cy={10} r={3} />
    <circle className="st0" cx={10} cy={32} r={3} />
    <circle className="st0" cx={54} cy={32} r={3} />
    <circle className="st0" cx={48} cy={16} r={2} />
  </svg>
);
